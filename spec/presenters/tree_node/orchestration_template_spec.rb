describe TreeNode::OrchestrationTemplate do
...

  {
    ...
    :orchestration_template_orange_in_yaml       => %w(ManageIQ::Providers::Orange::CloudManager::OrchestrationTemplate thot),
    ...
    :vnfd_template_orange_in_yaml                => %w(ManageIQ::Providers::Orange::CloudManager::VnfdTemplate tvnfd),
