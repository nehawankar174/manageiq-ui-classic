...
module Mixins
  module EmsCommonAngular
    ...
    OTC_AMQP_PARAMS = %i[name provider_region api_version amqp_secuFrity_protocol keystone_v3_domain_id amqp_hostname amqp_api_port project_name amqp_userid event_stream_selection].freeze
