class ApplicationHelper::Button::VmSnapshotRevert < ApplicationHelper::Button::Basic
  ...
  def visible?
    ...
    return false if @record.kind_of?(ManageIQ::Providers::Openstack::CloudManager::Vm) || @record.kind_of?(ManageIQ::Providers::Telefonica::CloudManager::Vm) || @record.kind_of?(ManageIQ::Providers::Orange::CloudManager::Vm)
    super
  end
