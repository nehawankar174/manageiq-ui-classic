class ApplicationHelper::Button::ProviderUserSync < ApplicationHelper::Button::Basic
  ...
  def visible?
    ...
    (@record.class == ManageIQ::Providers::Openstack::CloudManager || @record.class == ManageIQ::Providers::Telefonica::CloudManager || @record.class == ManageIQ::Providers::Huawei::CloudManager || @record.class == ManageIQ::Providers::Otc::CloudManager || @record.class == ManageIQ::Providers::Orange::CloudManager) && @record.tenant_mapping_enabled == true
  end
end
