module VmHelper::TextualSummary
  ...
  def textual_retirement_date
    ...
    return nil if @record.kind_of?((ManageIQ::Providers::Openstack::CloudManager::Template) || (ManageIQ::Providers::Telefonica::CloudManager::Template) || (ManageIQ::Providers::Huawei::CloudManager::Template) || (ManageIQ::Providers::Orange::CloudManager::Template))
