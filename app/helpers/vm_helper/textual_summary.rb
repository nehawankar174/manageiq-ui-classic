module VmHelper::TextualSummary
  ...
  def textual_retirement_date
    # Click2Cloud: Added telefonica/orange/huawei cloudmanager template condition
    return nil if @record.kind_of?(ManageIQ::Providers::Openstack::CloudManager::Template) || @record.kind_of?(ManageIQ::Providers::Telefonica::CloudManager::Template) || @record.kind_of?(ManageIQ::Providers::Huawei::CloudManager::Template) || @record.kind_of?(ManageIQ::Providers::Orange::CloudManager::Template)
