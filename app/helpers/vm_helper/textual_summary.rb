module VmHelper::TextualSummary
  ...
  def textual_retirement_date
    # Click2Cloud: Added telefonica/orange/huawei/otc cloudmanager template condition
    return nil if @record.kind_of?((ManageIQ::Providers::Openstack::CloudManager::Template) || (ManageIQ::Providers::Telefonica::CloudManager::Template) || (ManageIQ::Providers::Huawei::CloudManager::Template) || (ManageIQ::Providers::Otc::CloudManager::Template) || (ManageIQ::Providers::Orange::CloudManager::Template))
