class TreeBuilderOrchestrationTemplates < TreeBuilder
  ...
  # Click2Cloud: Added telefonica/orange/huawei/otc cloudmanager templates
  def x_get_tree_custom_kids(object, count_only, _options)
    classes = {
      ...
      "ohohot" => ManageIQ::Providers::Otc::CloudManager::OrchestrationTemplate,
      ...
      "ohtvnf" => ManageIQ::Providers::Otc::CloudManager::VnfdTemplate,
